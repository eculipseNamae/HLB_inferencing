...
#define EI_CLASSIFIER_PROJECT_ID                 796945
#define EI_CLASSIFIER_PROJECT_OWNER              "MSU - Iligan Institute of Technology | Computer Applications Department"
#define EI_CLASSIFIER_PROJECT_NAME               "HLB5"
